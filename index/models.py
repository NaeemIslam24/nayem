...
class Testimonial(models.Model):
    ...
    image = models.ImageField(upload_to='testimonial', default='testimonial/testimonial-1.jpg') 
...
class Client(models.Model):
    ...
    company_logo = models.ImageField(upload_to='clients', default='clients/client-1.png') 
